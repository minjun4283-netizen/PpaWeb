...
> **서버가 아직 없다면**: 이 웹앱(편집 가능, 서버 필요)을 올릴 사내망 서버가
> 준비되기 전까지 임시로 쓸 수 있는, **서버가 전혀 필요 없는 조회 전용 정적
> HTML 대시보드**를 `_program/static-dashboard/`에 따로 만들어뒀습니다. 자세한
> 내용은 해당 폴더의 README를 참고하세요.
