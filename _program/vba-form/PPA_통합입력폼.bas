...
'==============================================================================
' PPA 통합 입력/조회 폼
'   ※ 이 파일은 ANSI(CP949)로 저장돼 있습니다. VBE의 [파일 가져오기]가
'      한국어 Windows 기본 코드페이지로 읽기 때문입니다. 메모장 등으로 다시
'      저장할 일이 있으면 인코딩을 반드시 'ANSI'로 두세요. UTF-8로 저장하면
'      가져올 때 한글이 깨지면서 "허가된 개체 이름이 아닙니다" 오류가 납니다.
'------------------------------------------------------------------------------
' 목적
