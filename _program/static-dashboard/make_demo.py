...
tables_data = {
    ...
    "T_판매계약": [
        {"판매계약ID": "판매-D001-2024-01", "수요기업ID": "D001", "판매계약용량(MW)": "1.0",
         ...
         "계약기간(년)": "10", "Requirement": "New", "MGA_Demand": "0.1", "계약 단계": "계약 완료"},
        {"판매계약ID": "판매-D001-2024-01", "수요기업ID": "D001", "판매계약용량(MW)": "1.2",  # PK 중복
         ...
         "계약기간(년)": "10", "Requirement": "New", "MGA_Demand": "0.1", "계약 단계": "계약 협의 완료"},
        {"판매계약ID": "판매-D002-2026-01", "수요기업ID": "D002", "판매계약용량(MW)": "4.0",
         ...
         "계약기간(년)": "8", "Requirement": "New", "MGA_Demand": "0.11", "계약 단계": "계약 협의 중"},
    ],
    "T_전기사용지": [
    ...
    "T_수급매칭": [
        ...
        {"수급매칭ID": "매칭-006", "전기사용지ID": "전기사용지-D001-2024-01",
         "구매계약ID": "구매-P003-2026-01", "현황": "6. 이슈 발생", "원인": "한전 이슈"},
