...
Dim fso, shell, scriptDir, workDir, xlsmPath, pyExe, logPath, workerBat, cmd
...
Else
    xlsmPath = FindSingleXlsm(workDir)
    If xlsmPath = "" Then
        MsgBox "상위 폴더(" & workDir & ")에서 xlsm 파일을 정확히 하나 찾지 " & _
